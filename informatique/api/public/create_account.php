    ...
    <div class="max-w-md mx-auto p-6">
        ...
        <form method="post">
            <div class="mb-4">
                ...
                <input name="first_name" type="text" id="email"
            ...
            <div class="mb-4">
                <label for="password" class="block text-eventit-500"
                    data-lang="Confirmation du mot de passe|Password confirmation">Confirmation du mot de passe</label>
                <input name="password" type="password" id="password"
                    class="w-80 h-9 px-2 py-2 border rounded-3xl border-eventit-500 focus:outline-none focus:ring focus:border-eventit-500">
            </div>
            <div class="text-center">
                <button type="submit"
                    class="w-3/5 bg-eventit-500 text-white py-2 px-4 rounded-3xl hover:bg-eventit-600 focus:outline-none focus:ring focus:border-eventit-500 button"
                    data-lang="Créer le compte|Create account">Créer le compte</button>
            </div>
        </form>
