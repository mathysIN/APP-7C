                    ...
                    <div>
                        ...
                        <form method="post">
                            <div class="flex flex-col items-center gap-4">
                                <textarea type="color" id="primary_color" name="primary_color" class="p-2 w-full min-h-72 rounded-md border border-gray-300 focus:outline-none focus:ring focus:ring-blue-200"><?php echo $legalContent; ?></textarea>
