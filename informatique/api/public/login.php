    ...
    <div class="max-w-md mx-auto p-2">
        ...
        <form method="post">
            ...
            <div class="text-center">
                <button type="submit"
                    class="w-4/5 bg-eventit-500 text-white py-2 px-4 rounded-3xl hover:bg-eventit-600 focus:outline-none focus:ring focus:border-eventit-500 button"
                    data-lang="Se connecter|Login">Se connecter</button>
            </div>
        </form>
        <div class="text-center underline">
            <a href="create_account" class="mt-2 text-center text-eventit-500"
                data-lang="Créer un compte|Create account">Créer un compte</a>
        </div>
    </div>
</div>
<style>
