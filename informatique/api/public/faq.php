...
function mapSectionLabel($sectionName)
{
    switch ($sectionName) {
        case 'event-it':
            return 'Event-it';
        ...
        <div class="max-w-[650px] flex flex-col gap-5 items-center justify-center">
            ...
            <div class="flex gap-3 justify-between w-full">
                <?php foreach ($sections as $section): ?>
                    <button
                        class="w-[20%] min-w-[100px] max-w-[650px] text-lg px-4 py-2 border rounded-3xl  bg-eventit-500 text-white focus:outline-none focus:ring focus:border-eventit-500 section-button"
                ...
                <?php endforeach; ?>
                <button
                    class="w-[20%] min-w-[100px] max-w-[650px] text-lg px-2 py-2 border rounded-3xl bg-eventit-500 text-white focus:outline-none focus:ring focus:border-eventit-500 section-button"
                    çl: id=" showAllButton">Voir tout</button>
            </div>
