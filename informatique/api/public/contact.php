<div class="h-full py-20 flex flex-col justify-top">
    ...
    <div class="max-w-md mx-auto p-6 text-center">
        ...
        <textarea id="message" class="w-80 h-40 px-2 py-2 border rounded-3xl border-eventit-500 focus:outline-none focus:ring focus:border-eventit-500" placeholder="Un problème, une question, n'hésitez pas à nous contacter sur nos réseaux" rows="5"></textarea>
      </div>
