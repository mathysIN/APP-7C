<div class="flex flex-col w-full">
    <section class="relative h-[500px] md:h-[700px] lg:h-[580px] bg-cover" style="background-image: url(/resources/home.jpg);">
        ...
        <div class="relative z-10 flex flex-col justify-center items-center md:items-start md:pl-24 text-center md:text-left h-[600px]">
            <h1 class="text-7xl md:text-8xl font-extrabold text-eventit-500">EVENT - IT</h1>
            <p class="mt-4  text-white text-4xl ">
                Solutions d'évènements
            </p>
            <a class="inline-flex w-80 mt-8 px-8 py-3 text-sm font-medium text-white bg-eventit-500 rounded-3xl justify-center hover:bg-eventit-500" href="#">
                DU TEXTE
            </a>
        </div>
    </section>
    <section class="relative py-52 items-center flex flex-col min-h-[500px] md:min-h-[700px] lg:min-h-[500px] bg-gray-300">
        <div class="flex flex-col md:flex-row justify-center items-center  gap-20 px-2 md:px-40 text-zinc-600 w-full md:w-2/3 text-center md:text-left">
            <div class="w-3/4 md:text-right font-semibold text-4xl">Installation de solutions « clé en main »</div>
            <div class="w-3/4 text-2xl">Gérer avec habilité une large game d’événements et introduire la qualité sonore
                à ces événements </div>
        </div>
        <a class="inline-flex w-60 mt-8 px-8 py-3 text-sm font-medium text-white bg-eventit-500 rounded-3xl justify-center hover:bg-eventit-500" href="#">
            DU TEXTE
        </a>
    </section>
